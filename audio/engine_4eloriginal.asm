...
Audio4_callchannel:
    ...
    call Audio4_GetNextMusicByte ; yes
    push af
    call Audio4_GetNextMusicByte
    ld d, a
    pop af
...
Audio4_sfxnote:
    ...
    jr nz, Audio4_pitchenvelope ; no
    ld a, c
    cp Ch3 ; is this a noise or sfx channel?
    jr c, Audio4_pitchenvelope ; no
    ld b, $0
    ld hl, wChannelFlags2
    add hl, bc
    bit 0, [hl]
    jr nz, Audio4_pitchenvelope ; no
    call Audio4_notelength ; yes
    ld d, a
    ld b, $0
    ld hl, wChannelDuties
    add hl, bc
