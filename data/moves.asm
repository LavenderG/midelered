...
MoveEnd:
	...
	move IRON_HEAD,   NO_ADDITIONAL_EFFECT,        80, STEEL,      100, 20
	...
	move MIDELE_POWER, TRAPPING_EFFECT,				     100, MIDELE,  100,   5
	move DARK_THUNDER, TWO_TO_FIVE_ATTACKS_EFFECT,  80, MIDELE,  100,   5
