UnknownDungeon1Object:
	...
	object SPRITE_BLACK_HAIR_BOY_2, 24, 16, STAY, DOWN, 2, OPP_GOLDY, 1 
	object SPRITE_YOUNG_BOY, 20, 16, STAY, LEFT, 3, OPP_UTALAWEA, 1	
	object SPRITE_BLACK_HAIR_BOY_1, 16, 15, STAY, RIGHT, 4, OPP_EEVEETO, 1 
	object SPRITE_BIKER, 24, 14, STAY, RIGHT, 5, OPP_JAVISIT, 1
	object SPRITE_BLACK_HAIR_BOY_1, 16, 14, STAY, RIGHT, 6, OPP_DARKI, 1
	object SPRITE_BALL, 7, 13, STAY, NONE, 7, FULL_RESTORE
	object SPRITE_BALL, 19, 3, STAY, NONE, 8, MAX_ELIXER
	object SPRITE_BALL, 5, 0, STAY, NONE, 9, NUGGET
