...
MapHS0D:
	...
	db ROUTE_2,$02,Show  ; MOON STONE
	db ROUTE_2,$03,Show ; PP_UP ; NUEVO PARA ENTRENADOR NUEVO, AÑADIDO PARA QUE HAYA 3 OBJECTS FUNCIONANDO EN ROUTE 2
MapHS0F:
	db ROUTE_4,$03,Show
MapHS14:
	db ROUTE_9,$0A,Show
...
MapHSE4:
	db UNKNOWN_DUNGEON_1,$07,Show ; NUEVO SUBIDO DE 01 a 02 PARA ENTRENADOR NUEVO
	db UNKNOWN_DUNGEON_1,$08,Show ; NUEVO SUBIDO DE 02 a 03 PARA ENTRENADOR NUEVO
	db UNKNOWN_DUNGEON_1,$09,Show ; NUEVO SUBIDO DE 03 A 04 PARA ENTRENADOR NUEVO
MapHS8F:
