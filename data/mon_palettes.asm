MonsterPalettes:
	...
	db PAL_CYANMON    ; SWABLU
	db PAL_CYANMON    ; ALTARIA
	db PAL_BROWNMON   ; GRUBBIN
	...
	db PAL_REDMON   ; PORYGON2
	db PAL_REDMON   ; PORYGONZ
